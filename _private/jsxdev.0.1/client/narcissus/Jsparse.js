...
* License.
*
* The Original Code is the definitions.Narcissus JavaScript engine.
*
...
/*
* definitions.Narcissus - JS implemented in JS.
*
* Parser.
*/

include('narcissus/Jslex.js');
include('narcissus/Jsdefs.js');

define(function() {

    var lexer = narcissus.Jslex;
    var definitions = narcissus.Jsdefs;

    var StringMap = definitions.StringMap;
    ...
    */
    ...
    function StaticContext(parentScript, parentBlock, inModule, inFunction) {
        ...
        this.blackList = blackLists[definitions.Narcissus.options.version];
        definitions.Narcissus.options.ecma3OnlyMode && (this.ecma3OnlyMode = true);
        definitions.Narcissus.options.parenFreeMode && (this.parenFreeMode = true);
    }
    ...
    */
    ...
    Class('narcissus.Jsparse', null, null, {
        parse: parse,
