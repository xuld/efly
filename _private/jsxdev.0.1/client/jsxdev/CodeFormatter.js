...
define(function(){
    ...
    function js_beautify(js_source_text, options) {
        ...
        function get_next_token() {
            ...
            do {
                ...
                if (c === "\n") {
                    n_newlines += 1;
                    print_newline(); //update;
                }
            } while (in_array(c, whitespace));
            var wanted_newline = false;
            if (opt_preserve_newlines) {
                if (n_newlines > 1) {
                    for (var i = 0; i < n_newlines; i++) {//修改
                        print_newline(i === 0);
                    }
                }
            ...
            if (c === '[') {
                return [c, 'TK2_START_EXPR'];
            }
            if (c === ']') {
                return [c, 'TK2_END_EXPR'];
            }
            if (c === '{') {
    ...
    */
    ...
    Class('jsxdev.CodeFormatter', null, null, {
