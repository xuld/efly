...
include('ace/keyboard/StateHandler.js');

define(function() {

    var StateHandler = ace.keyboard.StateHandler;
    var matchCharacterOnly = StateHandler.matchCharacterOnly;
    ...
    var vimStates = {
        ...
        vimcommand("u", "undo"),
        {
            // [count] on this may/may not work, depending on browser implementation...
    ...
    Class('ace.keyboard.keybinding.Vim', null, null, {

        instance: new StateHandler(vimStates)
