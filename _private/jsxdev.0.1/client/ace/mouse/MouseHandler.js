...
include('ace/mouse/DefaultHandlers.js');
include('ace/mouse/MouseEvent.js');

define(function() {

    var event = ace.lib.Event;
    var DefaultHandlers = ace.mouse.DefaultHandlers;
    var MouseEvent = ace.mouse.MouseEvent;

    Class('ace.mouse.MouseHandler', null, {
        ...
        onMouseWheel: function(e) {
            ...
            //UPDATE
            mouseEvent.speed = this.$scrollSpeed * (Jsx.UA.WINDOWS ? 6 : 2);
