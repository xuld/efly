...
include('ace/lib/BrowserFocus.js');

define(function() {

    var event = ace.lib.Event;
    var dom = ace.lib.Dom;
    var EventEmitter = ace.lib.EventEmitter;
    var BrowserFocus = ace.lib.BrowserFocus;
    ...
    Class('ace.mouse.DefaultHandlers', ace.lib.EventEmitter, {

        DefaultHandlers: function(editor) {
            this.editor = editor;
