...
define(function() {
    ...
    Class('ace.layer.Marker', null, {

        Marker: function(parentEl) {
        ...
        $getTop: function(row, layerConfig) {
        ...
        */
        drawTextMarker: function(stringBuilder, range, clazz, layerConfig) {
            // selection start
        ...
        */
        drawMultiLineMarker: function(stringBuilder, range, clazz, layerConfig, type) {
            // from selection start to the end of the line

            var padding = (type === "background" ? 0 : this.$padding);
            var height = layerConfig.lineHeight;
            var width = Math.round(layerConfig.width - (range.start.column * layerConfig.characterWidth)) - padding;
            ...
            width = layerConfig.width - padding;
        ...
        */
        drawSingleLineMarker: function(stringBuilder, range, clazz, layerConfig, extraLength, type) {
            var padding = type === "background" ? 0 : this.$padding;
            var height = layerConfig.lineHeight;
