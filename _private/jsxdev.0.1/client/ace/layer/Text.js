...
define(function() {
    ...
    Class('ace.layer.Text', ace.lib.EventEmitter, {

        Text: function(parentEl) {
        ...
        $renderToken: function(stringBuilder, screenColumn, token, value) {
            var self = this;
        ...
        $renderLineCore: function(stringBuilder, lastRow, tokens, splits, onlyContents) {
            var chars = 0;
            var split = 0;
            var splitChars;
        ...
        $renderLine: function(stringBuilder, row, tokens, onlyContents) {
        ...
        $renderFoldLine: function(stringBuilder, row, tokens, onlyContents) {
