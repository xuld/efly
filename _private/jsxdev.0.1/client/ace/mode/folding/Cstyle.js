...
define(function() {
    ...
    var _foldingStartMarker = /(\{|\[)[^\}\]]*$|^\s*(\/\*)/;
    var _foldingStopMarker = /^[^\[\{]*(\}|\])|^[\s\*]*(\*\/)/;

    Class('ace.mode.folding.Cstyle', ace.mode.folding.Fold, {

        get foldingStartMarker() {
            return _foldingStartMarker;
        },
        
        get foldingStopMarker() {
            return _foldingStopMarker;
        },
