...
define(function() {
    ...
    Class('ace.mode.folding.Xml', ace.mode.folding.Fold, {

        Xml: function(voidElements) {
            this.voidElements = voidElements || {};
            //this.tagRe = /^(\s*)(<?(\/?)([-_a-zA-Z0-9:!]*)\s*(\/?)>?)/;
        },

        getFoldWidget: function(session, row) {
            var tags = session.getTokens(row, row)[0].tokens.filter(function(token) {
