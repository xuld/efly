...
define(function() {
    ...
    Class('ace.mode.Html', ace.mode.Text, {

        Html: function() {

            var highlighter = new ace.mode.HtmlHighlightRules();
            this.$tokenizer = new ace.Tokenizer(highlighter.getRules());
            this.$behaviour = new ace.mode.behaviour.XmlBehaviour();
            ...
            this.foldingRules = new ace.mode.folding.Xml({
                "area": 1,
                "base": 1,
                "br": 1,
                "col": 1,
