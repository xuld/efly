...
include('ace/mode/PowershellHighlightRules.js');
...
define(function() {
    ...
    Class('ace.mode.Powershell', ace.mode.Text, {

        Powershell: function() {
            this.$tokenizer = new ace.Tokenizer(new ace.mode.PowershellHighlightRules().getRules());
            this.$outdent = new ace.mode.MatchingBraceOutdent();
            this.$behaviour = new ace.mode.behaviour.CstyleBehaviour();
            this.foldingRules = new ace.mode.Cstyle();
        },
