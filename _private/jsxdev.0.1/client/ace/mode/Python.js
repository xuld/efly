...
include('ace/mode/PythonHighlightRules.js');
include('ace/mode/folding/Python.js');
...
define(function() {
    ...
    Class('ace.mode.Python', ace.mode.Text, {

        Python: function() {
            this.$tokenizer = new ace.Tokenizer(new ace.mode.PythonHighlightRules().getRules());
            this.foldingRules = new ace.mode.folding.Python();
        },
