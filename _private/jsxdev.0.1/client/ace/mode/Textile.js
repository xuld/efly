...
include('ace/mode/TextileHighlightRules.js');
include('ace/mode/MatchingBraceOutdent.js');
include('ace/Range.js');

define(function() {

    Class('ace.mode.Textile', ace.mode.Text, {

        Textile: function() {

            this.$tokenizer = new ace.Tokenizer(new ace.mode.TextileHighlightRules().getRules());
