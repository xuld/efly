...
include('ace/mode/ClojureHighlightRules.js');
include('ace/mode/MatchingParensOutdent.js');
...
define(function() {
    ...
    Class('ace.mode.Clojure', ace.mode.Text, {

        Clojure: function() {
            this.$tokenizer = new ace.Tokenizer(new ace.mode.ClojureHighlightRules().getRules());
            this.$outdent = new ace.mode.MatchingParensOutdent();
        },
