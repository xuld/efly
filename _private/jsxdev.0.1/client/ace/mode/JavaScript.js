...
include('ace/mode/JavaScriptWorker.js');
include('Jsx/Thread.js'); //多线程

define(function() {

    var Range = ace.Range;

    Class('ace.mode.JavaScript', ace.mode.Text, {
        ...
        createWorker: function(session) {
            ...
            //UPDATE
            var thread = new Jsx.Thread('ace/mode/JavaScriptWorker.js', 'ace.mode.JavaScriptWorker');
            ...
            thread.on("narcissus", function(e) {
