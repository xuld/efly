...
define(function() {
    ...
    Class('ace.Search', null, {
        ...
        set: function(options) {
            Jsx.extend(this.$options, options);
            return this;
        },
        ...
        $forwardMatchIterator: function(session) {
            var re = this.$assembleRegExp();
            var self = this;
        ...
        $backwardMatchIterator: function(session) {
            var re = this.$assembleRegExp();
            var self = this;
        ...
        $rangeFromMatch: function(row, column, length) {
        ...
        $forwardLineIterator: function(session) {
        ...
        $backwardLineIterator: function(session) {
            var searchSelection = this.$options.scope == Search.SELECTION;
