...
define(function() {
    ...
    Class('ace.Selection', ace.lib.EventEmitter, {
        ...
        */
        ...
        shiftSelection: function(columns) {
            if (this.$isEmpty) {
        ...
        setSelectionRange: function(range, reverse) {
        ...
        moveCursorTo: function(row, column, preventUpdateDesiredColumn) {
        ...
        moveCursorToScreen: function(row, column, preventUpdateDesiredColumn) {
