...
Ext.ux.tree.TreeGrid = Ext.extend(Ext.tree.TreePanel, {
    ...
    initComponent: function() {
        ...
        if (this.enableSort) {
            var info = this.sortInfo;
            this.treeGridSorter = new Ext.ux.tree.TreeGridSorter(this,
                    info ? { property: info.field, dir: info.direction, folderSort: true} : null
                );
        }
    ...
    updateColumnWidths: function() {
        ...
        this.outerCt.select('table').setWidth(this.forceFit ? this.getInnerWidth() : tcw);
