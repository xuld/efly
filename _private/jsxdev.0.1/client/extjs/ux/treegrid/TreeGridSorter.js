    ...
    */
    ...
    onHeaderClick: function(c, el, i) {
        ...
        if (c && c.sortable && !this.tree.headersDisabled) {
            ...
            me.sortFn = c.sortFn || this.sortFn;
    ...
    doSort: function(node) {
        ...
        var index = this.tree.columns.propertyIndexOf('dataIndex', this.property);

        if (index !== -1 && columns[index].sortable) {
            node.sort(this.sortFn);
            this.updateSortIcon(index, this.dir);
        }
    },
