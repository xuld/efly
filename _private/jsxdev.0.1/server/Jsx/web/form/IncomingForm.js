/**
 * @class Jsx.web.form.IncomingForm
 * @extends Jsx.Event
...
include('Jsx/web/form/File.js');
include('Jsx/web/form/MultipartParser.js');
include('Jsx/web/form/QuerystringParser.js');
...
define(function() {
    ...
    var MultipartParser = Jsx.web.form.MultipartParser;
    var QuerystringParser = Jsx.web.form.QuerystringParser;
    var File = Jsx.web.form.File;
    ...
    Class('Jsx.web.form.IncomingForm', null, {
         ...
         * @param {Jsx.web.service.HttpService}
         * @constructor
         */
