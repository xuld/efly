...
define(function() {
    ...
    /**
     * @class Jsx.db.mysql.Connect.private$connect
     * @extends Object
     * @createTime 2012-01-13
     * @updateTime 2012-01-13
    ...
    Class('private$connect', null, {
        ...
        private$connect: function(opt, cb) {
            Jsx.Delegate.def(this, 'error', 'packet');
    ...
    Class('Jsx.db.mysql.Connect', null, null, {
