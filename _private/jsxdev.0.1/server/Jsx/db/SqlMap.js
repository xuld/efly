...
include('Jsx/db/mysql/Mysql.js');
include('Jsx/db/Database.js');
include('Jsx/memcached/Memcached.js');
include('Jsx/xml/Document.js');
include('node/crypto.js');

define(function(global) {
    var crypto = node.crypto;
    var Database = Jsx.db.Database;
    var Node = Jsx.xml.Node;
    var memcached = Jsx.memcached.Memcached.get();
    var cache = {};
    var MAPS = {};
    var INSTANCE;
    var REG = /\{(.+?)\}/g;
    ...
    /**
     * @class Jsx.db.SqlMap.private$transaction
     * @extends Object
     * @createTime 2012-01-18
     * @updateTime 2012-01-18
    ...
    Class('private$transaction', null, {
        ...
        /**
         * database
         * @type {Jsx.db.Database}
         */
        db: null,

        /**
         * constructor function
         * @param {Jsx.db.SqlMap} sqlMap
         * @constructor
         */
    ...
    /**
     * @class Jsx.db.SqlMap Half of the object with disabilities
     * @extends Object
     * @createTime 2012-01-18
     * @updateTime 2012-01-18
     * @author www.mooogame.com, Simplicity is our pursuit
    ...
    function getOriginalMap(_this, name) {
        ...
        if (!map) {
            ...
            var id = ls.pop();
            var prefix = ls.join('.') + '.';
            var filename = Jsx.format(ls.join('/')) + '.xml';
            var doc = new Jsx.xml.Document();
    ...
    function getDb(_this) {
        ...
        var db = _this.db;
        var klass = Jsx.get(_this.type);

        if (klass && Jsx.equals(klass, Database))//select server
    ...
    Class('Jsx.db.SqlMap', null, {
        ...
        /**
         * start transaction
         * @return {Jsx.db.SqlMap.private$transaction}
         */
        ...
        get: function() {
            if (!INSTANCE)
                INSTANCE = new Jsx.db.SqlMap(Jsx.Config.get('dao'));
            return INSTANCE;
        }
