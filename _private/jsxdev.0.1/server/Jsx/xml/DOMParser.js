...
define(function() {
    ...
    /**
     * @class Jsx.xml.DOMParser.private$attributes
     * @extends Object
    ...
    /**
     * @class Jsx.xml.DOMParser.private$xmlreader
     * @extends Object
     * @createTime 2012-01-18
     * @updateTime 2013-01-18
     * @author www.mooogame.com, Simplicity is our pursuit
    ...
    function parseElementStart(_this, source) {
        ...
        //print(stack+'#'+nsStack)
        nsStack = config.nsStack = (nsMap ? Jsx.extend(Jsx.extend({}, nsStack), nsMap) : nsStack);
    ...
    /**
     * @class Jsx.xml.DOMParser.private$domhandler
     * @extends Object
     * @createTime 2012-01-18
     * @updateTime 2013-01-18
     * @author www.mooogame.com, Simplicity is our pursuit
    ...
    var DOMHandler =
    Class('private$domhandler', null, {

        /**
         * constructor function    
         * @param {Jsx.xml.Document} doc (Optional)
         * @param {Jsx.xml.Element} el   (Optional)
         * @constructor
         */
        ...
        startDocument: function() {
            this.document = new Jsx.xml.Document();
            if (this.locator)
        ...
        startDTD: function(name, publicId, systemId) {
            var doc = this.document;
            var doctype = new Jsx.xml.DocumentType(name, publicId, systemId);
            doc.doctype = doctype;
     ...
     * @version 1.0
     */
    Class('Jsx.xml.DOMParser', null, {

        /**
         * constructor function    
         * @param  {String}          source
         * @return {Jsx.xml.Document}
         * @constructor
         */
        ...
        /**
         * constructor function    
         * @param  {Jsx.xml.Document} doc 
         * @param  {Jsx.xml.Element}  el   
         * @param  {String}          source
         * @return {Jsx.xml.Document}
         * @constructor
         */
