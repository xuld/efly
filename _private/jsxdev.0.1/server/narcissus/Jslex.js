...
define(function() {
    ...
    Class('narcissus.Tokenizer', null, {
        
        /*
         * Tokenizer :: (source, filename, line number) -> Tokenizer
         */
        Tokenizer: function (s, f, l) {
            this.cursor = 0;
        ...
        lexString: function (ch) {
            ...
            while ((ch = input[this.cursor++]) !== delim) {
                ...
                if (ch === '\\') {
                    ...
                    if(ch == 'u' || ch == 'U') {
                        ...
                        var reg = /[0-9a-fA-F]/;
                        while(i--){
                            if(!(ch = input[++this.cursor]) || !reg.test(ch)) 
                                throw this.newSyntaxError('should be hex \\u0FF0');
                        }
                    }
                    else if(ch == '\n' || ch == '\r') 
                        this.lineno++;
            ...
            try{
                ...
                throw this.newSyntaxError(e.message);
            }
            //UPDATE END
        },
    ...
    Class('narcissus.Jslex', null, null, {
    
        Tokenizer: narcissus.Tokenizer
